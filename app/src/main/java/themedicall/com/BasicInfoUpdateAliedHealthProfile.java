...
public class BasicInfoUpdateAliedHealthProfile extends Fragment implements SearchView.OnQueryTextListener, AddingNewCategoryInterface {
    ...
    public BasicInfoUpdateAliedHealthProfile() {
    ...
    public void setSelectCity()
    {
        ...
        btCity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                search_view.setOnQueryTextListener(BasicInfoUpdateAliedHealthProfile.this);
...
/*
                    ...
                    BioUpdateAliedHealthProfile.bioRegistration.setAdapter(adapter1);
                    BioUpdateAliedHealthProfile.bioRegistration.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        @Override
...
ad
                            ...
                            if (id.equals("-1")){
                                ...
                                BioUpdateAliedHealthProfile.bioRegistration.setText("");
                                ...
                                BioUpdateAliedHealthProfile.fl_for_reegistration.setVisibility(View.VISIBLE);
                                BioUpdateAliedHealthProfile.fl_for_reegistration.addView(child);
                                BioUpdateAliedHealthProfile.bioRegistration.setText("");
              ...
              /*      BioUpdateAliedHealthProfile bioUpdateDoctorProfile = new BioUpdateAliedHealthProfile();
...
//        });
        ...
        btSpecialist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (UpdateAliedHelathProfile.specialityList.size()>0) {
                    ...
                    specialist.setAdapter(new SpecialityCustomAdapter(getActivity(), UpdateAliedHelathProfile.specialityList, specialityid, selectedSpecialityList));
   ...
   /* private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context arg0, Intent arg1) {
            ...
            if (datapassed == 1) {
                ...
                UpdateAliedHelathProfile.dialog.hide();
                etFullName.setText(GetAllDoctorDetailService.doctor_full_name);
                etDob.setText(GetAllDoctorDetailService.doctor_dob);
                BioUpdateAliedHealthProfile.et_video_url.setText(GetAllDoctorDetailService.doctor_video);
         ...
         *//*
            ...
            *//*CitiesGetterSetter citiesGetterSetter = (CitiesGetterSetter)adapter.getItem(i);
            ...
            for (int i = 0; i < sizeInstituationsArray; i++) {
                ...
                BioUpdateAliedHealthProfile.fl_for_institution.setVisibility(View.VISIBLE);
                BioUpdateAliedHealthProfile.fl_for_institution.addView(child);
                BioUpdateAliedHealthProfile.bioInstitution.setText("");
            ...
            if (sizeExpertiesArray>0){
                for (int i = 0; i < sizeExpertiesArray; i++) {
                    ...
                    BioUpdateAliedHealthProfile.fl_for_experties.setVisibility(View.VISIBLE);
                    BioUpdateAliedHealthProfile.fl_for_experties.addView(child);
                    BioUpdateAliedHealthProfile.bioExpertise.setText("");

                }
            }

            BioUpdateAliedHealthProfile.bioAboutMe.setText(GetAllDoctorDetailService.doctor_about_me);
            BioUpdateAliedHealthProfile.bioAchievements.setText(GetAllDoctorDetailService.doctor_achievements);
            BioUpdateAliedHealthProfile.bioPublications.setText(GetAllDoctorDetailService.doctor_publications);

            BioUpdateAliedHealthProfile.bioExtraCurricular.setText(GetAllDoctorDetailService.doctor_extra_curricular_activities);
            BioUpdateAliedHealthProfile.bioWorkExperience.setText(GetAllDoctorDetailService.doctor_experience);
            BioUpdateAliedHealthProfile.checkUpDiscount.setText(GetAllDoctorDetailService.doctor_discount_for_check_up);
            BioUpdateAliedHealthProfile.procedureDiscount.setText(GetAllDoctorDetailService.doctor_discount_for_procedure);
            BioUpdateAliedHealthProfile.otherDiscount.setText(GetAllDoctorDetailService.doctor_detail_for_other_discount);
            BioUpdateAliedHealthProfile.writeAboutOtherPercent.setText(GetAllDoctorDetailService.doctor_detail_for_other_discount);
            BioUpdateAliedHealthProfile.writeAboutOtherWelfarePanel.setText(GetAllDoctorDetailService.doctor_want_to_join_medicall_welfare_panel);
            ...
            if (offerAnyDiscountSwitchState.equals("Yes")){
                BioUpdateAliedHealthProfile.discountPackageGetText = "Yes";
                BioUpdateAliedHealthProfile.discountPackageSwitch.setChecked(true);
            }
            if (welFareChennalCheckSwitchState.equals("Yes")){
                BioUpdateAliedHealthProfile.welfarePanelGetText = "Yes";
                BioUpdateAliedHealthProfile.welfarePanelSwitch.setChecked(true);
            }
            if (availableForvideoConsultationSwitchState.equals("Yes")){
                BioUpdateAliedHealthProfile.videoConsultationGetText = "Yes";
                BioUpdateAliedHealthProfile.videoConsultationSwitch.setChecked(true);
            }
            if (availableForHomeCareServicesSwitchState.equals("Yes")){
                BioUpdateAliedHealthProfile.homeCareServiceGetText = "Yes";
                BioUpdateAliedHealthProfile.homeCareServiceSwitch.setChecked(true);
            }
            if (wanttoBecomeBloodDonorSwitchState.equals("Yes")){
                BioUpdateAliedHealthProfile.becomeBloodDonorGetText = "Yes";
                BioUpdateAliedHealthProfile.becomeBloodDonorSwitch.setChecked(true);
            }
            ...
            if (socialMedicaCheckboxState.equals("Yes")){
                BioUpdateAliedHealthProfile.socialMediaCheckBoxGetText = "Yes";
                BioUpdateAliedHealthProfile.socialMediaCheckBox.setChecked(true);
            }
            if (quriesAnwerCheckboxState.equals("Yes")){
                BioUpdateAliedHealthProfile.queriesAnswerCheckBoxGetText = "Yes";
                BioUpdateAliedHealthProfile.queriesAnswerCheckBox.setChecked(true);
            }
            if (medicallCampchCheckboxState.equals("Yes")){
                BioUpdateAliedHealthProfile.medicalCampCheckBoxGetText = "Yes";
                BioUpdateAliedHealthProfile.medicalCampCheckBox.setChecked(true);
            }
            if (bloodCamcheckboxState.equals("Yes")){
                BioUpdateAliedHealthProfile.bloodCampCheckBoxGetText = "Yes";
                BioUpdateAliedHealthProfile.bloodCampCheckBox.setChecked(true);
            }
            if (healthArticleCheckBoxState.equals("Yes")){
                BioUpdateAliedHealthProfile.healthArticleCheckBoxGetText = "Yes";
                BioUpdateAliedHealthProfile.healthArticleCheckBox.setChecked(true);
            }
            if (otherCheckBoxState.equals("Yes")){
                BioUpdateAliedHealthProfile.otherCheckBoxGetText = "Yes";
                BioUpdateAliedHealthProfile.otherCheckBox.setChecked(true);
            }
               ...
               Glide
                       ...
                       .into(new SimpleTarget<Bitmap>(300,300) {
                           ...
                           public void onResourceReady(Bitmap resource, GlideAnimation glideAnimation) {
                               ...
                               BioUpdateAliedHealthProfile.fetchList.add(new CitiesGetterSetter(imageId, imageURIFromBitmap));
                               settingImageToAdpter(BioUpdateAliedHealthProfile.fetchList);
                               Log.e("TAG", "Feteched Array List Size 1: " + BioUpdateAliedHealthProfile.fetchList.size());
...
*/
    ...
    public void autocompleteSubExperties()
    {
        ...
        BioUpdateAliedHealthProfile.bioExpertise.setAdapter(adapterExperties);
        //setting OnItemclick
        BioUpdateAliedHealthProfile.bioExpertise.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (id.equals("-1")){
                    ...
                    boolean isMatched = false;
                    int totalviewForServices = BioUpdateAliedHealthProfile.fl_for_experties.getChildCount();
                    if (totalviewForServices>0){
                        for (int s = 0; s<totalviewForServices; s++){

                            View v =  BioUpdateAliedHealthProfile.fl_for_experties.getChildAt(s);
                            TextView ID = (TextView) v.findViewById(R.id.tv_id);
                            TextView title = (TextView) v.findViewById(R.id.tv_tag);
                            String subspecialistId = ID.getText().toString();
                            String mTitle = title.getText().toString();
    ...
    public void onClickForSubRegistrationsCrossTag(){
        ...
        int totalViesForSubRegistrations = BioUpdateAliedHealthProfile.fl_for_reegistration.getChildCount();
        for (int i = 0; i<totalViesForSubRegistrations; i++){
            final View child = BioUpdateAliedHealthProfile.fl_for_reegistration.getChildAt(i);
            ImageView iv = (ImageView) child.findViewById(R.id.iv_tag_crose);
            ...
            iv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("TAg", "the specialist title: " + specialistTilt.getText().toString());
                    Log.e("TAg", "the specialist Id: " + specialistId.getText().toString());
                    final int total = BioUpdateAliedHealthProfile.fl_for_reegistration.getChildCount();
    ...
    public void onClickForSubInstituationsCrossTag(){
        ...
        int totalViesForSubRegistrations = BioUpdateAliedHealthProfile.fl_for_institution.getChildCount();
        for (int i = 0; i<totalViesForSubRegistrations; i++){
            final View child = BioUpdateAliedHealthProfile.fl_for_institution.getChildAt(i);
            ImageView iv = (ImageView) child.findViewById(R.id.iv_tag_crose);
            ...
            iv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("TAg", "the specialist title: " + specialistTilt.getText().toString());
                    Log.e("TAg", "the specialist Id: " + specialistId.getText().toString());
                    final int total = BioUpdateAliedHealthProfile.fl_for_institution.getChildCount();
    ...
    public void onClickForSubExpertiseCrossTag(){
        ...
        int totalViesForSubExpertiese = BioUpdateAliedHealthProfile.fl_for_experties.getChildCount();
        for (int i = 0; i<totalViesForSubExpertiese; i++){
            final View child = BioUpdateAliedHealthProfile.fl_for_experties.getChildAt(i);
            ImageView iv = (ImageView) child.findViewById(R.id.iv_tag_crose);
            ...
            iv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("TAg", "the specialist title: " + specialistTilt.getText().toString());
                    Log.e("TAg", "the specialist Id: " + specialistId.getText().toString());
                    final int total = BioUpdateAliedHealthProfile.fl_for_experties.getChildCount();
...
*//*
                ...
                if (id.equals("-1")){
                    ...
                    if (totalViewForRegistration > 0) {
                        for (int s = 0; s < totalViewForRegistration; s++) {
                            View v = BioUpdateAliedHealthProfile.fl_for_reegistration.getChildAt(s);
                            TextView ID = (TextView) v.findViewById(R.id.tv_id);
                            TextView title = (TextView) v.findViewById(R.id.tv_tag);
                            String subspecialistId = ID.getText().toString();
                            String mTitle = title.getText().toString();
    ...
    public void bioInstitutionAutoCompleteWithListener()
    {
        ...
        BioUpdateAliedHealthProfile.bioInstitution.setAdapter(adapter2);
        BioUpdateAliedHealthProfile.bioInstitution.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (id.equals("-1")){
                    ...
                    if (totalViewForInstitution > 0) {
                        for (int s = 0; s < totalViewForInstitution; s++) {
                            View v = BioUpdateAliedHealthProfile.fl_for_institution.getChildAt(s);
                            TextView ID = (TextView) v.findViewById(R.id.tv_id);
                            TextView title = (TextView) v.findViewById(R.id.tv_tag);
                            String subspecialistId = ID.getText().toString();
                            String mTitle = title.getText().toString();
    ...
    public void bioExpertiseAutoCompleteWithListener()
    {
        ...
        BioUpdateAliedHealthProfile.bioExpertise.setAdapter(adapter3);
        BioUpdateAliedHealthProfile.bioExpertise.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
    ...
    private void removingSubViesOfSpeciality(final View child, final String mSpecialistyId){
        ...
        int totalSubExper = BioUpdateAliedHealthProfile.fl_for_experties.getChildCount();
        ...
        if (totalSubExper>0) {
            for (int subExp = totalSubExper; subExp >= 0; subExp--) {
                ...
                View childSubQua = BioUpdateAliedHealthProfile.fl_for_experties.getChildAt(subExp);
                if (childSubQua!=null) {
                    ...
                    if (mSpecialistyId.equals(subExpId)) {
                        ...
                        Log.e("TAG", "It is Equal ");
                        BioUpdateAliedHealthProfile.fl_for_experties.removeView(childSubQua);
        ...
        if (totalRemaingSpecialities>0) {
            ...
            BioUpdateAliedHealthProfile.bioExpertise.setAdapter(adapterRegistrations);
