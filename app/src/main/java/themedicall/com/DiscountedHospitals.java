...
public class DiscountedHospitals extends Fragment {
    public static RecyclerView recyclerView_hospitals_discounted ;
    public static LinearLayoutManager linearLayoutManager;
    public static ProgressBar bar;
    public static TextView emptyViewDiscounted;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_discounted_hospitals, container, false);
    ...
    public void initiate(View view)
    {
        ...
        recyclerView_hospitals_discounted = (RecyclerView) view.findViewById(R.id.recycler_view_discounts_hospitals);
        recyclerView_hospitals_discounted.setHasFixedSize(true);
        linearLayoutManager = new LinearLayoutManager(getActivity() , LinearLayoutManager.VERTICAL, false);
        recyclerView_hospitals_discounted.setLayoutManager(linearLayoutManager);
        bar = (ProgressBar) view.findViewById(R.id.loadmore_discounts_hospitals_progress);
        emptyViewDiscounted = (TextView) view.findViewById(R.id.emptyViewDiscounted);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser)
        {
            ...
            if(discountedHospitalsServiceHasRun)
            {
...
//                                }
                        ...
                        {
                            emptyViewDiscounted.setVisibility(View.VISIBLE);
                            recyclerView_hospitals_discounted.setVisibility(View.GONE);
                        }
                        else
                        {
                            hospitalsListRecycleView = new HospitalsListRecycleView(getActivity() , discountedHospitalsList);
                            recyclerView_hospitals_discounted.setAdapter(hospitalsListRecycleView);
                            hospitalsListRecycleView.notifyDataSetChanged();
                        }



                        discountedHospitalsServiceHasRun = true ;
...
//                                }
    ...
    public void discountedHospitalsPaginationScrollListener(){
        ...
        recyclerView_hospitals_discounted.addOnScrollListener(new PaginationScrollListener(linearLayoutManager, totalDataOnServer) {
