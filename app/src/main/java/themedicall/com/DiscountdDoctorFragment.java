...
public class DiscountdDoctorFragment extends Fragment {
    ...
    public static RecyclerView recyclerView_discounted_Doc;
    ...
    public static TextView emptyViewDiscountedDr ;
    Double rating ;

    public DiscountdDoctorFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_discountd_doctor, container, false);
...
//        discountDocPaginationScrollListener();
    ...
    {
        emptyViewDiscountedDr = (TextView) view.findViewById(R.id.emptyViewDiscountedDr);

        dialog=new CustomProgressDialog(getActivity(), 1);
        bar = (ProgressBar) view.findViewById(R.id.loadMore_discounted_doc_progress);
        //loadingImage = (TextView) view.findViewById(R.id.loadingDiscountedDoc);
        progressDialog = new ProgressDialog(getContext());
        progressDialog.setCancelable(false);
        recyclerView_discounted_Doc = (RecyclerView) view.findViewById(R.id.recycler_view_discounted_doc);
        recyclerView_discounted_Doc.setHasFixedSize(true);
        linearLayoutManager = new LinearLayoutManager(getActivity() , LinearLayoutManager.VERTICAL, false);
        recyclerView_discounted_Doc.setLayoutManager(linearLayoutManager);
        recyclerView_discounted_Doc.setAdapter(findDoctorListRecycleView);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        {
                            emptyViewDiscountedDr.setVisibility(View.VISIBLE);
                            recyclerView_discounted_Doc.setVisibility(View.GONE);
                        }
                        else
                        {
                            findDoctorListRecycleView = new FindDoctorListRecycleView(getContext() , discountedDocList);
                            recyclerView_discounted_Doc.setAdapter(findDoctorListRecycleView);
    ...
    public void discountDocPaginationScrollListener(){
        ...
        recyclerView_discounted_Doc.addOnScrollListener(new PaginationScrollListener(linearLayoutManager, totalDataOnServer) {
