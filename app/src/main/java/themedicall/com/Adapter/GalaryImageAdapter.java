...
public class GalaryImageAdapter extends RecyclerView.Adapter<GalaryImageAdapter.MyViewHolder> {

    private ArrayList<String> mImagesList;
    private Context mContext;
    private SparseBooleanArray mSparseBooleanArray;

    public GalaryImageAdapter(Context context, ArrayList<String> imageList) {
        mContext = context;
