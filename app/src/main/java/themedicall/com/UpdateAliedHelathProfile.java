...
public class UpdateAliedHelathProfile extends AppCompatActivity {
    ...
    BasicInfoUpdateAliedHealthProfile basic;
    BioUpdateAliedHealthProfile fragBio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //startService(new Intent(UpdateAliedHelathProfile.this, GetAllDoctorDetailService.class));
    ...
    public void initiate()
    {
        ...
        basic = new BasicInfoUpdateAliedHealthProfile();
        fragBio = new BioUpdateAliedHealthProfile();
        ...
        dialog = new CustomProgressDialog(UpdateAliedHelathProfile.this, 1);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new BasicInfoUpdateAliedHealthProfile(), "Basic Info");
        adapter.addFragment(new PrecticeDetailUpdateAliedHealthProfile(), "Practice");
      ...
      /*  String experience_status = null;
        ...
        adapter.addFragment(new BioUpdateAliedHealthProfile(), "Bio");
    ...
    public void onAddFieldLab(View v) {
        ...
        int count = PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount();
        PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.addView(rowView, PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount() - count);
        Log.d("tag" , "Press Delete Btn " + PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount());


        if (PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount()>1){

            for (int i = 0; i<PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount(); i++) {

                View view =  PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildAt(i);
    ...
    public void onRemovingSpecialisity(View v){
        ...
        // int totalviewForSpecialist = BasicInfoUpdateAliedHealthProfile.rl_custom_specialist_tags.indexOfChild(v);
        Toast.makeText(this, "Remove Called " + indexOfMyView , Toast.LENGTH_SHORT).show();
    /*    View view =  BasicInfoUpdateAliedHealthProfile.rl_custom_specialist_tags.getFocusedChild();
    ...
    public void onDeleteLab(View v) {
        ...
        int totalViewCount = PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount();
        ...
        if (totalViewCount==1) {
            ...
            PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.removeView((View) (v).getParent());
        }
        //Log.d("tag" , "Press Delete Btn " + PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount());
    ...
    /*    progressDialog.setMessage("Please Waite ...");
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, "http://docbookpk.com/test/medi-app-api/test" , new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(UpdateAliedHelathProfile.this,
    ...
    public void startTimePicker(final View v){
        ...
        mTimePicker = new TimePickerDialog(UpdateAliedHelathProfile.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void endTimePicker(final View v){
        ...
        mTimePicker = new TimePickerDialog(UpdateAliedHelathProfile.this, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                ...
                //
                final int totalViewCount = PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount();
                for (int i = 0; i<totalViewCount; i++){
                    final View child = PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildAt(i);
                    ...
                    if (etEndTime.equals(etMyEndTime)){
                        ...
                        if (first.equals(aTime)){
                            Toast.makeText(UpdateAliedHelathProfile.this, "Start And End Time Should not be Same", Toast.LENGTH_SHORT).show();
                            etEndTime.setText("");
                            break;
                        }
                        else {
...

    {
        ...
        final Dialog dialog = new Dialog(UpdateAliedHelathProfile.this);
        ...
        cityListView.setAdapter(new DaysSelectAdapter(UpdateAliedHelathProfile.this , dayslit));
    ...
    public void getSpecialityList()
    {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(UpdateAliedHelathProfile.this, errorMsg, Toast.LENGTH_LONG).show();
                    }
        ...
        strReq.setRetryPolicy(new DefaultRetryPolicy(
                ...
                DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        // Adding request to request queue
        AppSingleton.getInstance(UpdateAliedHelathProfile.this).addToRequestQueue(strReq, cancel_req_tag);
    }
    ...
    protected void onDestroy() {
       // Intent stopService = new Intent(UpdateAliedHelathProfile.this, GetAllDoctorDetailService.class);
        ...
        for (int i = 0; i<totalViewCount; i++){
            ...
            ivDelet.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    final int tVies = PrecticeDetailUpdateAliedHealthProfile.medicineCustomRow.getChildCount();
                    child.postInvalidate();
                    if (tVies == 1) {
                        Toast.makeText(UpdateAliedHelathProfile.this, "No More Item to Remove", Toast.LENGTH_SHORT).show();
                    } else {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        HospitalFilterAdapterForPrecticeUpdateDoc hospitalFilterAdapter = new HospitalFilterAdapterForPrecticeUpdateDoc(UpdateAliedHelathProfile.this, HospitalNameFilter);
                        ...
                        String errorMsg = jObj.getString("error_message");
                        Toast.makeText(UpdateAliedHelathProfile.this , "error "+ errorMsg, Toast.LENGTH_LONG).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
        ...
        editText.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (id.equals("-1")){
                    ...
                    AlertDialog.Builder alertAddingNewHospital = new AlertDialog.Builder(UpdateAliedHelathProfile.this);
                    ...
                    alertAddingNewHospital.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            Intent createNewHospitalActivity = new Intent(UpdateAliedHelathProfile.this, MapActivityForSelectingHospital.class);
    ...
    private void setClickForAutoCompleForHospitalNameFilter(final AutoCompleteTextView editText, final TextView hostId){
        ...
        editText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Dialog autoDialog = new Dialog(UpdateAliedHelathProfile.this);
