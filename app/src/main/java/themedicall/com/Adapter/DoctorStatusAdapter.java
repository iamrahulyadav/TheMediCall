...
/**
 * Created by User-10 on 14-Dec-17.
 */

public class DoctorStatusAdapter extends BaseAdapter {

    private List<String> mListItems;
    private LayoutInflater mLayoutInflater;
    Context context;

    public DoctorStatusAdapter(Context context, List<String> arrayList){
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.imageView.setImageResource(R.drawable.docstatus);
