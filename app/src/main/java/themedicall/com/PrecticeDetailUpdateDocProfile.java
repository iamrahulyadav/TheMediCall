...
public class PrecticeDetailUpdateDocProfile extends Fragment {
    ...
    public PrecticeDetailUpdateDocProfile() {
    ...
    public void addingDymanicView(int totalViewSize, ArrayList<ArrayList<HashMap<String, String>>> precticeListData) {
        ...
        if (totalViewSize > 0){
            PrecticeDetailUpdateDocProfile.medicineCustomRow.removeAllViews();
        }
        ...
        for (int s = 0; s<totalViewSize; s++){
            ...
            PrecticeDetailUpdateDocProfile.medicineCustomRow.addView(rowView, PrecticeDetailUpdateDocProfile.medicineCustomRow.getChildCount()-1);
