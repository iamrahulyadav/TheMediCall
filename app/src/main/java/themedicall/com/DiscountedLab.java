...
public class DiscountedLab extends Fragment {

    RecyclerView recycler_view_disconted_labs;
    TextView emptyViewDiscountedLabList;
    ProgressBar bar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_discounted_lab, container, false);
    ...
    public void initiate(View view)
    {
        ...
        recycler_view_disconted_labs = (RecyclerView) view.findViewById(R.id.recycler_view_disconted_labs);
        recycler_view_disconted_labs.setHasFixedSize(true);
        linearLayoutManager = new LinearLayoutManager(getActivity() , LinearLayoutManager.VERTICAL, false);
        recycler_view_disconted_labs.setLayoutManager(linearLayoutManager);
        discountedLabsList = new ArrayList<>();
        emptyViewDiscountedLabList = (TextView) view.findViewById(R.id.emptyViewDiscountedLabList);
        bar = (ProgressBar) view.findViewById(R.id.loadmore_discounted_Lab_progress);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        {
                            emptyViewDiscountedLabList.setVisibility(View.VISIBLE);
                        }
                        else
                        {
                            labsListRecycleView = new LabsListRecycleView(getActivity() , discountedLabsList);
                            recycler_view_disconted_labs.setAdapter(labsListRecycleView);
    ...
    public void discountedLabPaginationScrollListener(){
        ...
        recycler_view_disconted_labs.addOnScrollListener(new PaginationScrollListener(linearLayoutManager, totalLab) {
