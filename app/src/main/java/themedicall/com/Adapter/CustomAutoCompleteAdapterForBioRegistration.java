...
public class CustomAutoCompleteAdapterForBioRegistration extends ArrayAdapter<CitiesGetterSetter> {

    Context context;
    int resource, textViewResourceId;
    ArrayList<CitiesGetterSetter> items, tempItems, suggestions;

    public CustomAutoCompleteAdapterForBioRegistration(Context context, int resource, int textViewResourceId, ArrayList<CitiesGetterSetter> items) {
